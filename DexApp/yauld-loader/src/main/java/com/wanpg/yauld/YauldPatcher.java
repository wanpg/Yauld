            ...
            if (activities != null) {
                for (Activity activity : activities) {
                    ...
                    try {
                        ...
                        if (SDK_INT < N) { // As of API 24, mTheme is gone (but updates work
                        ...
                        Log.e("YauldDex", "Failed to update existing theme for activity " + activity,
                                e);
                    }
